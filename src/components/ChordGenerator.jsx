...
const ChordGenerator = () => {
  ...
  const handleChordExtensionChange = (event) =>
    setChordExtensionLevel(event.target.value);

  const handleRhythmPatternChange = (event) =>
    setRhythmPattern(event.target.value);

  const handlePatternTypeChange = (event) => setPatternType(event.target.value);

  const handleStructuralPatternToggle = () =>
    setUseStructuralPattern(!useStructuralPattern);
  ...
  const formatChord = (chord) => {
    ...
    const quality = getQualitySymbol(
    ...
    if (chord.bass && chord.bass !== `${chord.root}2`) {
      ...
      return (
        <>
          {base}
          <span className="chord-inversion">/{bassNote}</span>
        </>
      );
    }
    return base;
        ...
        <div className="controls">
          ...
          <div className="chord-extensions-control">
            ...
            <div className="control-hint">
              {chordExtensionLevel === "none" &&
                "Simple major and minor chords"}
              {chordExtensionLevel === "sevenths" &&
                "Adds 7th chords like dominant7 and minor7"}
              {chordExtensionLevel === "extended" &&
                "Includes 9th chords and more colors"}
              {chordExtensionLevel === "full" &&
                "Rich jazz harmony with advanced extensions"}
            </div>
          </div>
          ...
          <div className="advanced-options-toggle">
            <button onClick={toggleAdvancedOptions} className="toggle-button">
              {showAdvancedOptions
            ...
            <div className="advanced-options">
              ...
              <div className="option-section">
                ...
                <div className="chord-mode-toggle structural-toggle">
                  ...
                  <span className="toggle-hint">
                    Occasionally use common patterns
                  </span>
                </div>
              </div>
            </div>
